...
/* =========================
   ...
   ========================= */
//evaluates into true or false (....condition)  use a conditional to control the flow of your code bringing in the concept of truthy and falsy values
...
if statement
  syntax:
      ...
      else ---> default statement attached to the block of code that runs if the condition is false
...
//   console.log(total)
// }else{
//   console.log("Please enter a number for the amount of pieces you want")
// }
...
// let randomVar = 'whatever' this switch statement is going to compare randomVar to the cases and run the code in the case that matches randomVar
// switch (randomvar){
...
// let userInput = "b" this switch statement is going to compare userInput to the cases and run the code in the case that matches userInput
// let win = false;
//   switch (userInput) {
//     case "a":// "a" === userInput
...
// function chooseDoor(door) { this switch statement is going to compare door to the cases and run the code in the case that matches door
  // let win = false;
  // switch (userInput) {
  //   case "a":// "a" === userInput
  //     console.log("Wrong door, you lose.");
...
// if(user !== "Guest"){ this switch statement is going to compare user to the cases and run the code in the case that matches user
//   switch (key) {
//     case "STUDENT":
...
// while(i < colors.length ){ // colors.length = 3 console.log(colors.length -1); //will always give you the last index of an array because arrays are 0 indexed
...
// for...of: iterate values of an iterable (arrays, strings, etc.) Only used for Arrays or strings
//arrays, strings
/*
syntax:
...
//continue ---> skips certain items in a loop while still finishing the loop
  //parsing user input. stops current iteration and moves on to the next one
// for(let i = 1; i <= 10; i++){
//   if(i % 2 === 0){
//     continue;
//   }
